            ...
            do
            {
                ...
                switch (answer)
                {
                    ...
                    case "3":
                        ...
                        for (int i = 0; i < n; i++)
                        {
                            DBCustomer u = new DBCustomer("TestIme", "TestPrezime", "TestFon", "TestMail", "T", 123, customerService.Count());
                    ...
                    case "7":
                        ...
                        DBCustomer updateModel = new DBCustomer(n, "UpdateIme", "UpdatePrezime", "UpdateFon", "UpdateMAil", "U", 321, customerService.Count()+1);
